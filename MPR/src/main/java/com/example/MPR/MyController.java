...
public class MyController {
    ...
    public ResponseEntity<Dog> putDog(@PathVariable Long id,@RequestParam String name,@RequestParam int age,@RequestParam String color){
        service.updateDog(id, name, color, age);
